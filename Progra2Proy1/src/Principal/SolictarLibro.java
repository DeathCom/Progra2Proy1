 ...
 * @author cperezme
 */
public class SolictarLibro extends javax.swing.JFrame {

    /**
     * Creates new form SolictarLibro
     */
    public SolictarLibro() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SolictarLibro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SolictarLibro().setVisible(true);
            }
        });
    }
